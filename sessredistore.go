...
func NewRedisStore(conn redis.Cmdable, keyPairs ...[]byte) *RedisStore {
	return &RedisStore{
		Cmd:    conn,
...
func (s *RedisStore) Delete(ctx context.Context, r *http.Request, w http.ResponseWriter, session *sessions.Session) error {
